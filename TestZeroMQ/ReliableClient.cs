...
namespace ReliablePubSub.Client
{
    public class ReliableClient : IDisposable
    {
        ...
        /// <param name="welcomeMessageHandler"></param>
        public ReliableClient(IEnumerable<string> addresses, TimeSpan heartbeatTimeOut, TimeSpan reconnectInterval,
            Action<NetMQMessage> subscriberMessageHandler = null,
            Action<Exception, NetMQMessage> subscriberErrorHandler = null, Action welcomeMessageHandler = null)
        {
